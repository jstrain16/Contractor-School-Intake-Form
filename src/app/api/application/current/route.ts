...
export async function GET() {
  try {
    ...
    console.error("GET /api/application/current error", err)
...
export async function PATCH(req: Request) {
  try {
    ...
    // Milestone notifications omitted for brevity
    return NextResponse.json({ ok: true, prevProgress, newProgress })
  } catch (err) {
    console.error("PATCH /api/application/current error", err)
