...
export default function SupportingMaterialsPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <main className="mx-auto max-w-5xl px-4 pb-16 pt-8 space-y-6">
        <header className="flex items-start justify-between">
          <div>
            <div className="text-xs text-slate-500">Step 2 of 2</div>
            <h1 className="text-lg font-semibold text-slate-900">Supporting Materials</h1>
          </div>
        ...
        <div className="space-y-4">
          {CATEGORY_ORDER.map((cat) => {
            ...
            return (
              <Card key={cat} className={`border border-slate-200 bg-gradient-to-br ${CARD_BG[cat] ?? "from-white to-white"}`}>
